...
class PogodaCard extends StatelessWidget {
  final String title;
  ...
  const PogodaCard({Key key, this.title, this.temperature, this.iconCode, this.temperatureFontSize = 32, this.iconScale = 2}) : super(key: key);
...
//Карточка погоды отображает температуру, иконку и заголовок
